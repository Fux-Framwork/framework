...
use Fux\Database\Model\FuxDataModel;
use Fux\Database\SqlWhere;
use Traversable;
...
class Model implements \JsonSerializable, \ArrayAccess, \IteratorAggregate
{
     ...
     *
     * @return \Fux\Database\FuxQueryBuilder
     */
    public static function queryBuilder()
    {
        return (new \Fux\Database\FuxQueryBuilder())->select(static::$tableFields)->from(static::$tableName);
    }
